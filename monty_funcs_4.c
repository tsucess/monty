...
void monty_rotle(stack_t **stack, unsigned int line_number);
 ...
 * @stack: A pointer to the top mode node of astack_t linked list.
...
/**
 * monty_rotr - Rotates the top value of a stack_t linked list to the bottom.
 * @stack: A pointer to the top mode node of astack_t linked list.
 * @line_number: The current working line number of a Monty bytecode file.
 */
...
void monty_queue(stack_t **stack, unsigned int linr_number)
{
	(*stack)->n = QUEUE;
	(void)line_number;
}
